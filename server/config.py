...
NODE_SERVER = os.environ.get("PROXY3X_NODE_SERVER", os.environ.get("PROXY3X_SHADOWROCKET_NODE_SERVER", "vpn-us.songjiaaa.ccwu.cc"))
ALT_SUBSCRIPTION_DOMAIN = os.environ.get("PROXY3X_ALT_SUBSCRIPTION_DOMAIN", "vpn-us.songjiaaa.ccwu.cc")
SHADOWROCKET_NODE_SERVER = NODE_SERVER
